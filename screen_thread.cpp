...
void screen_thread::set_params(struct device_settings *dev_parms)
{
  ...
  params.chandisplay[0] = deviceparms->chan[0].display;
  params.chandisplay[1] = deviceparms->chan[1].display;
  params.chandisplay[2] = deviceparms->chan[2].display;
  params.chandisplay[3] = deviceparms->chan[3].display;
  params.chanscale[0] = deviceparms->chan[0].scale;
  params.chanscale[1] = deviceparms->chan[1].scale;
  params.chanscale[2] = deviceparms->chan[2].scale;
  params.chanscale[3] = deviceparms->chan[3].scale;
